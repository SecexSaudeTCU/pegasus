...
"""
Cria o schema do banco de dados do SINAN_DENG (Agravos dengue e chikungunya) para atender ao formato do SGBD postgreSQL.
...
# Incorpora o schema do banco de dados do SINAN_DENG definido nas classes abaixo
Base = declarative_base()

# Tabela de notificações dos agravos dengue e chikungunya (DENG) (tabela principal do banco de dados)
class DENGBR(Base):
