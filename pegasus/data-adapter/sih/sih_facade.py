...
class SIHFacade:
    ...
    def get_df_procedimentos_ano_para_analise(self, df_analise, df_populacao):
    ...
    def get_df_nivel(self, df_analise, df_populacao):
        df_nivel = self.get_df_procedimentos_ano_para_analise(df_analise, df_populacao).groupby('NIVEL').count()[
            'ANO'].reset_index()
    ...
    def get_df_nivel_procedimento(self, df_analise, df_populacao):
        df_nivel_proc = self.get_df_procedimentos_ano_para_analise(df_analise, df_populacao)[
    ...
    def get_df_descricao_procedimentos(self, df_proc_ano_analise):
        start_time = time.time()
    ...
    def get_df_procedimentos_por_ano_com_descricao(self, df_descricao_procedimentos, df_proc_ano_analise):
        #df_proc_ano_analise = self.get_df_procedimentos_ano_para_analise(df_analise, df_populacao)
    ...
    #TODO: Está calculando errado para o procedimento '0201010208'
