...
"""
Cria o schema do sub banco de dados do CNES_EF (Estabelecimentos Filantrópicos) para atender ao formato do SGBD postgreSQL.
Na verdade o schema abaixo deve atender ao formato dos SGBD Oracle e SQL Server com no máximo pequenas modificações.

"""

# Função de criação das tabelas do sub banco de dados cnes_ef
def create_tables(connection_data, child_db):
    ...
    cursor.execute(f'''/*Tabela Estabelecimentos Filantrópicos (tabela principal do sub banco de dados cnes_ef)*/
